...
//     document.write(`NAME — ${simpson.name} </br> SURNAME — ${simpson.surname} </br> AGE — ${simpson.age} </br>
//                     INFO — ${simpson.info} <br> <img src="${simpson.photo}" alt="${simpson.name} ${simpson.surname}"> </br>`);
// }
// document.write(`</div>`);
...
//     document.write(`<img src="${simpson.photo}" alt="${simpson.name} ${simpson.surname}">`);
// }
// document.write(`</div>`);
