...
//     div.innerHTML = `Імя - ${simpson.name} </br> Прізвище - ${simpson.surname} </br> Вік - ${simpson.age} </br>
//                     Інформація - ${simpson.info} </br> <img src="${simpson.photo}" alt="${simpson.name}">`
...
//
//     div.classList.add('member');
//     div1.innerHTML = `Імя - ${simpson.name}`;
//     div2.innerHTML = `Прізвище - ${simpson.surname}`;
//     div3.innerHTML = `Вік - ${simpson.age}`;
//     div4.innerHTML = `Інформація - ${simpson.info}`
//     div5.innerHTML = `<img src="${simpson.photo}" alt="${simpson.name}">`
//
//     document.body.append(div);
...
//
//     divWrap.style.cssText = `width: 50%; margin: 0 auto 10px auto; border: 2px solid black`
//     divTitle.innerText = `${course.title}`;
//     divTitle.style.cssText = `text-align: center; font-weight: bold;`;
//     divDuration.style.cssText = `display: flex;`
//     divMonthDuration.style.cssText = `width: 25%; text-align: center;`;
//     divHourDuration.style.cssText = `width: 75%; text-align: center;`;
...
//         li.innerText = course.modules[j];
//         ulModules.appendChild(li);
//     }
//
//     document.body.append(divWrap);
//     divWrap.append(divTitle, divDuration, divModules);
