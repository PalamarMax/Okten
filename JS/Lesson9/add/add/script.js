...
for (let i = 0; i < usersList.length; i++) {
    ...
    wrap.append(id,name,username,email,address,phone,website,company);
    address.append(street,suite,city,zipCode,geo);
    geo.append(lat,lng);
    company.append(companyName,companyCatchPhrase,companyBs);

    wrap.style.cssText = `width: 50%; margin:0 auto 10px auto; border: 2px solid tomato; background: lightblue;`
}